...
TMPDIR=$HOME kind load docker-image local/yunikorn:admission-amd64-latest  --name yunikorn
TMPDIR=$HOME kind load docker-image local/yunikorn:scheduler-amd64-latest  --name yunikorn
#TMPDIR=$HOME kind load docker-image local/yunikorn:webtest-amd64-latest  --name yunikorn
